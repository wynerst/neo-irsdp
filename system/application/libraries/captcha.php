...
function create_captcha($data = '', $img_path = '', $img_url = '', $font_path = '')
{
   ...
   if ($word == '')
   {
        ...
        $str = '';
        for ($i = 0; $i < 6; $i++)//time_out or time_stamp
        {
    ...
    */
	...
	$bg_color        = ImageColorAllocate($im, 222, 227, 255);
    $border_color    = ImageColorAllocate($im, 87, 108, 217);
    $text_color        = ImageColorAllocate($im, 85, 107, 217);
	
	/*foreach($test=0;$test<=6;$test+22)
	{
		$text_color= ImageColorAllocate($im, 85+($test+40)%$test, 107+($test+30)%$test, 217+($test+30)%$test);
	}*/
    $grid_color        = imagecolorallocate($im, 142, 161, 255);
...
/* Location: ./system/application/libraries/captcha.php */