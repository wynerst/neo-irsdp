...
?>
	...
	if($tmp['consultant'])
	{
		...
		$consultant .= "<li>" . $pay['nama'] . "</li>";
		endforeach;
?>
	<td><?php echo $consultant. "</ul>";?></td>
	<td align="right"><?php echo number_format($subcontract_value['idr']);?></td>
	<td align="right"><?php echo number_format($subcontract_value['usd']);?></td>
	<td align="right"><?php echo number_format($subcontract_value['usd_equiv']);?></td>
	<td align="right"><?php echo percentage($disb['sub_usd'],$subcontract_value['usd_equiv'])."%";?></td>
<?php
	$consultant ="<ul>";
