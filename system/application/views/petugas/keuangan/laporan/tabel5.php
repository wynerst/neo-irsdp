...
<tr>
	<td colspan="24">
	<h2 align="center">INFRASTRUCTURE REFORM DEVELOPMENT SECTOR PROJECT (IRSDP)<br />
	Loan ADB 2264-INO & Dutch Grant 0064-INO(IRSDP)<br />
	Status of Consultant Contracts<br />
	For Annual Report</h2>
	</td>
</tr>
<tr>
	<th rowspan="3">PIN</th>
...
<tr valign="top">
	...
	if($tmp['payment'])
	{
		foreach($tmp['payment'] as $key => $pay):	
