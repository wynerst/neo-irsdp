...
<tr>
	<th width="28px">No.</th>
	<th width="55px">PIN</th>
	<th width="80px">Sector</th>
	<th width="210px">Project Name</th>
	<th width="130px">Location</th>
	<th width="45px">Status</th>	
	<th width="90px">CRAM Report</th>
</tr>
...
<tr valign="top">
	...
	<td align="center"><a href="<?php echo site_url('petugas/adb_report_pac/'.$tmp->idproject_profile.'/1_asc');?>"><img src="<?php echo $this->config->item('icon_path')."page_red.png";?>" />&nbsp;&nbsp;PPC</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo site_url('petugas/adb_report_tac/'.$tmp->idproject_profile);?>"><img src="<?php echo $this->config->item('icon_path')."page.png";?>" />&nbsp;&nbsp;TAC</a></td>	
</tr>	
<?php endforeach;?>
<tr>
...
<?php endif;?>
<tr>
	<th colspan="7"><?php //echo $paging; ?></th>
</tr>
</table>