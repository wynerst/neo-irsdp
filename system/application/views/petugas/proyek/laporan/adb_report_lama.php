...
if($this->uri->segment(4)!='preview')
{
	if($this->uri->segment(2)=='adb_report_pac')
		...
		$lap_prev='adb_tac_preview';
	else
		$lap_prev='adb_all_preview';
?>
<div id="full-right">
	<ul>
		<li><a href="<?php echo site_url('petugas/'.$lap_prev.'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/preview'); ?>" target="_blank">Print Preview</a></li>
	</ul>
</div>
<br />
<?php } ?>
...
<tr>
	...
	<th width="70px">Achieved Date</th>
...
<?php if($this->uri->segment(4) != 'preview')
{
?>
<tr>
...
<tr>
  ...
  <td align="center"><?php echo $achive_date=$this->irsdp_model->get_achive_date($row->idref_status); ?></td>
  <td align="center"><?php if ($achive_date <> "0000-00-00") {
