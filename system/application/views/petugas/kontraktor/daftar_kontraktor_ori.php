...
<div id="head-right">
	<ul>
		<li><a href="<?php echo site_url('petugas/add_kontraktor');?>"><img src="<?php echo $this->config->item('icon_path')."add.png";?>" />&nbsp;Choose New Contractor</a></li>
	</ul>
</div>
<br /><br />
...
<tr class="<?php if($no%2==0) echo "nice-ganjil";
	...
	<td align="center"><a href="<?php echo site_url('petugas/detail_kontraktor/' . $tmp->idkontraktor);?>"><?php echo $this->irsdp_model->get_pinproject_for_kontrak($tmp->idproject_profile);?></a></td>
