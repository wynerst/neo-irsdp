...
$form_dest = 'petugas/modify_kontraktor';
...
<tr>
	...
	<td>
		<input type="radio" <?php if($tmp->tahapan=='PraFS')echo "checked=\"checked\""; ?>name="tahapan" value="PraFS"  />PraFS<br />
		<input type="radio" <?php if($tmp->tahapan=='Transaction')echo "checked=\"checked\""; ?>name="tahapan" value="Transaction"  />Transaction<br />
		<input type="radio" <?php if($tmp->tahapan=='Investor')echo "checked=\"checked\""; ?>name="tahapan" value="Investor"  />Investor<br />
		<input type="radio" <?php if($tmp->tahapan=='')echo "checked=\"checked\""; ?>name="tahapan" value=""  />Other Project
	</td>
</tr>
<tr>
...
<tr>
	...
	&nbsp;
	<input type="button" onclick="location.href='<?php echo site_url('petugas/list_kontraktor');?>'" value="Cancel" />
	</th>
</tr>
