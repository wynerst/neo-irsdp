...
<tr>
	...
	<td class="text"><?php echo number_format($row->anggaran_usd,2);?></td>
</tr>
<tr>
	<td class="label">Contract Budget (IDR)</td>
	<td class="text"><?php echo number_format($row->anggaran_idr);?></td>
</tr>
<tr>
	<td class="label">Total Contract Budget (US$)</td>
	<td class="text"><?php echo number_format($row->anggaran_total_usd,2);?></td>
</tr>
<tr>
...
<tr>
	<th colspan="2"><input type="button" onclick="location.href='<?php echo site_url('petugas/list_kontraktor');?>'" value="Back to Contractor List" /></th>
</tr>
</table>
<?php } ?>