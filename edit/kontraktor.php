...
if (isset($_POST['simpanData'])) {
	...
	$insert = $sql_op->insert('kontraktor', $data);
    if ($insert) {
	    echo '<script type="text/javascript">alert(\'Data kontraktor dibuat!\');</script>';
...
$form->addSelectList('idproject_profile', 'Nama Proyek', $array_dropdown, '');
...
$form->addSelectList('idperusahaan', 'Perusahaan', $array_dropdown, '');

// tgl_mulai
$form->addTextField('text', 'tgl_mulai', 'Tanggal mulai', '', 'style="width: 20%;"');

// tgl_selesai
$form->addTextField('text', 'tgl_selesai', 'Tanggal selesai', '', 'style="width: 20%;"');
...
$form->addRadio('tahapan', 'Tahapan Tender', $array_radio, 'PraFS');

// pcss_no
$form->addTextField('text', 'pcss_no', 'No PCSS', '', 'style="width: 50%;"');

// pcss_date
$form->addTextField('text', 'pcss_date', 'Tanggal PCSS', '', 'style="width: 50%;"');

// no_kontrak
$form->addTextField('text', 'no_kontrak', 'No Kontrak', '', 'style="width: 50%;"');

// tanggal_disetujui
$form->addTextField('text', 'tgl_disetujui', 'Tanggal Disetujui', '', 'style="width: 50%;"');

// anggaran_total_usd
$form->addTextField('text', 'anggaran_total_usd', 'Rencana Anggaran Total (USD)', '', 'style="width: 50%;"');

// anggaran_idr
$form->addTextField('text', 'anggaran_idr', 'Nilai Anggaran Rupiah', '', 'style="width: 50%;"');

// anggaran_total_usd
$form->addTextField('text', 'anggaran_usd', 'Nilai Anggaran USD', '', 'style="width: 50%;"');

// tambahkan element form textarea
$form->addTextField('textarea', 'catatan', 'Catatan', '', 'style="width: 100%;" rows="3"');
