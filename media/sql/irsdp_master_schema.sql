...
--
-- Host: localhost
-- Generation Time: Jan 20, 2011 at 04:48 PM
...
CREATE TABLE IF NOT EXISTS `permohonan` (
  ...
  `nilai_permintaan_rupiah` decimal(10,0) NOT NULL DEFAULT '0',
  `nilai_permintaan_dollar` decimal(10,0) NOT NULL DEFAULT '0',
  `nilai_disetujui_rupiah` decimal(10,0) NOT NULL DEFAULT '0',
  `nilai_disetujui_dollar` decimal(10,0) NOT NULL DEFAULT '0',
  `nilai_disetujui_eq_idr_usd` decimal(10,0) NOT NULL,
  `loan_adb_usd` decimal(10,0) NOT NULL,
  `grant_gov_usd` decimal(10,0) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `termin_bayar` (
  ...
  `eq_idr_usd` decimal(10,0) NOT NULL,
